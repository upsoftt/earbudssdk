...
#define ANC_GAIN_SIGN2_SET			0x84		//设置ANC各类增益的符号
#define ANC_LTRANS2_GAIN_SET		0x85		//设置ANC左声道辅听增益
#define ANC_RTRANS2_GAIN_SET		0x86		//设置ANC右声道辅听增益
#define ANC_HEARAID_HOWLDET_EN_SET			0x87		//设置辅听啸叫抑制使能
#define ANC_HEARAID_HOWLDET_THR_SET			0x88		//设置辅听啸叫抑制阈值
#define ANC_HEARAID_HOWLDET_GAIN_SET		0x89		//设置辅听啸叫抑制目标增益
#define ANC_HEARAID_HOWLDET_DITHER_THR_SET	0x8A		//设置辅听啸叫抑制消抖阈值
