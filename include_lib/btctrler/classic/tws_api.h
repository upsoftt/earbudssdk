...
#define TWS_SYNC_CALL_REGISTER(call) \
    static const struct tws_sync_call __tws_##call sec(.tws.text.sync_call)
...
#define REGISTER_TWS_FUNC_STUB(stub) \
    static const struct tws_func_stub stub sec(.tws.text.func_stub)
