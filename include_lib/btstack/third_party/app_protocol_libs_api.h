...
extern void realme_tws_data_deal(u8 *data, int len);
extern bool get_realme_connect_state(void);
...
///***************************************///
//NECM apis begins
extern int cloudmusic_process();
extern int cloudmusic_all_init(void);
extern int cloudmusic_all_exit(void);
//NECM API END

///***************************************///
//WSP apis begins
extern int wsp_all_init(void);
extern int wsp_all_exit(void);
extern void wsp_beacon_conn_type_set(u8 type);
extern void wsp_class_of_device_set(u8 *device_class);
extern int wsp_update_bt_state_to_lib(int sta);
extern void wsp_pair_timer_set(u32 msec);
extern void wsp_exit_pair_mode(void);
extern void wsp_enter_pair_mode(void);
//WSP API END
