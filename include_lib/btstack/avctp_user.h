...
/* 返回参数：一个通话一个来电 0X03；两个来电 0x08  两个通话 0x10 一个来电0x02  一个通话 0x01*/
...
#define BD_CLASS_CAR_AUDIO			0x240420 /*PBAP可以自动识别，但是新的IOS搜索不到*/
#define BD_CLASS_HIFI_AUDIO			0x240428
#define BD_CLASS_PHONEBOOK			0x340404 /*后来的IOS不能自动弹出提示了*/
