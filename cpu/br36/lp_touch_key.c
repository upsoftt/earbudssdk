...
static void __ctmu_short_click_time_out_handle(void *priv)
{
    ...
    case 5:
        ...
        break;
    case 6:
        e.u.key.event = KEY_EVENT_SIX_CLICK;
        break;
	case 7:
        e.u.key.event = KEY_EVENT_SEVEN_CLICK;
        break;
    default:
...
{
#if !EARPHONE_POWERON_CTRL_EN
if(__this->init == 0){
   return LP_TOUCH_SOFTOFF_MODE_LEGACY;
}
if((__this->softoff_mode == LP_TOUCH_SOFTOFF_MODE_ADVANCE)){
    lp_touch_key_disable();
	}
#endif //EARPHONE_POWERON_CTRL_EN
