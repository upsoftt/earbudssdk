...
enum {
    ...
    SYNC_TONE_ANC_OFF,
    SYNC_TONE_ANC_TRANS,
    SYNC_TONE_ANC_HEAR_AID_ON,
    SYNC_TONE_ANC_HEAR_AID_OFF,
    SYNC_TONE_EARDET_IN,
...
enum {
    ...
    SYNC_CMD_FIND_ALL_TONE_PLAY,
    SYNC_CMD_FIND_ALL_TONE_SOTP,
    SYNC_CMD_FIND_L_TONE,
    SYNC_CMD_FIND_R_TONE,

    SYNC_CMD_AUTO_ROLE_OFF,
    SYNC_CMD_EQ_TONE,
