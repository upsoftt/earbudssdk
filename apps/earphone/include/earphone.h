...
#define EARPHONE_STATE_BT_CONNECTED()           do { } while(0)
#define EARPHONE_STATE_BT_DISCONNECTED()        do { } while(0)
...
#define EARPHONE_CUSTOM_EARPHONE_KEY_INIT()             0
#define EARPHONE_PALY_STATUS_INDICATE(a)                0
#define EARPHONE_BATTERY_INDICATE(a)                    0
#define EARPHONE_VOLUME_INDICATE(a)                     0
#define EARPHONE_CUSTOM_EARPHONE_KEY_REMAP(a, b, c)     0
...
#define EARPHONE_STATE_BT_CONNECTED()           tuya_conn_state_set_and_indicate(1)
#define EARPHONE_STATE_BT_DISCONNECTED()        tuya_conn_state_set_and_indicate(0)
#define SYS_EVENT_HANDLER_SPECIFIC(a)           tuya_sys_event_handler_specific(a)
#define SYS_EVENT_REMAP(a) 				        0
#define EARPHONE_STATE_SNIFF(a)
#define EARPHONE_STATE_ROLE_SWITCH(a)
#define EARPHONE_CUSTOM_EARPHONE_KEY_INIT()              custom_earphone_key_init()
#define EARPHONE_PALY_STATUS_INDICATE(a)                 0//tuya_play_status_indicate(a)
#define EARPHONE_BATTERY_INDICATE(a)                     battery_indicate(a)
#define EARPHONE_VOLUME_INDICATE(a)                      volume_indicate(a)
#define EARPHONE_CUSTOM_EARPHONE_KEY_REMAP(a, b, c)      custom_earphone_key_remap(a, b, c)
