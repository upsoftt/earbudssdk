...
#define TONE_SIRI 			    SDFILE_RES_ROOT_PATH"tone/siri.*"
#define TONE_FIND_TONE 			SDFILE_RES_ROOT_PATH"tone/find_tone.*"
#define TONE_EQ_TONE 			SDFILE_RES_ROOT_PATH"tone/eq_tone.*"
#define TONE_LOW_LATENCY_IN     SDFILE_RES_ROOT_PATH"tone/g_mode.*"
#define TONE_LOW_LATENCY_OUT    SDFILE_RES_ROOT_PATH"tone/m_mode.*"
#define TONE_HANGUP             SDFILE_RES_ROOT_PATH"tone/hangup.*"
...
#define SINE_WTONE_MUTE             11

#if CONFIG_USE_DEFAULT_SINE
#undef TONE_TWS_CONN
#define TONE_TWS_CONN           DEFAULT_SINE_TONE(SINE_WTONE_MUTE)
#undef TONE_TWS_DISCONN
#define TONE_TWS_DISCONN        DEFAULT_SINE_TONE(SINE_WTONE_MUTE)
