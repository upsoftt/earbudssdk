...
const int CONFIG_A2DP_DATA_CACHE_LOW_AAC    = 100;//100
const int CONFIG_A2DP_DATA_CACHE_HI_AAC     = 250;//150

const int CONFIG_A2DP_DATA_CACHE_LOW_SBC    = 150;//120
const int CONFIG_A2DP_DATA_CACHE_HI_SBC     = 260;//160

const int CONFIG_A2DP_ADAPTIVE_MAX_LATENCY  = 550;
const int CONFIG_A2DP_DELAY_TIME            = 340 ;//200;/*修改延时值，注意修改CONFIG_A2DP_DATA_CACHE_LOW_AAC，HI_AAC，LOW_SBC，HI_SBC */
