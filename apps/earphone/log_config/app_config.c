...
const char log_tag_const_v_APP_CHARGE_CALIBRATION AT(.LOG_TAG_CONST) = FALSE;
const char log_tag_const_i_APP_CHARGE_CALIBRATION AT(.LOG_TAG_CONST) = TRUE;
const char log_tag_const_d_APP_CHARGE_CALIBRATION AT(.LOG_TAG_CONST) = FALSE;
const char log_tag_const_w_APP_CHARGE_CALIBRATION AT(.LOG_TAG_CONST) = TRUE;
const char log_tag_const_e_APP_CHARGE_CALIBRATION AT(.LOG_TAG_CONST) = TRUE;
