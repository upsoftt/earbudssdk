#ifndef CONFIG_BOARD_AC700N_IIS_LINEIN_CFG_H
#define CONFIG_BOARD_AC700N_IIS_LINEIN_CFG_H

#include "board_ac700n_iis_linein_global_build_cfg.h"
...
#elif (IIS_ROLE == ROLE_S && TCFG_ADC_IIS_ENABLE && TCFG_APP_LINEIN_EN)
#define TCFG_IOKEY_ENABLE					ENABLE_THIS_MOUDLE //是否使能IO按键
#define TCFG_IOKEY_POWER_ONE_PORT			IO_PORTC_01        //IO按键端口
#else
#define TCFG_IOKEY_ENABLE					ENABLE_THIS_MOUDLE //是否使能IO按键
#define TCFG_IOKEY_POWER_ONE_PORT			IO_PORTB_01        //IO按键端口
#endif
...
//                                 adkey 配置                                      //
//*********************************************************************************//
#if(IIS_ROLE == ROLE_M && TCFG_ADC_IIS_ENABLE && TCFG_APP_LINEIN_EN)	//iis主机配置adkey
#define TCFG_ADKEY_ENABLE                   ENABLE		//是否使能AD按键
#define TCFG_ADKEY_PORT                     IO_PORTB_01         //AD按键端口(需要注意选择的IO口是否支持AD功能)

#define TCFG_ADKEY_AD_CHANNEL               AD_CH_PB1
#define TCFG_ADKEY_EXTERN_UP_ENABLE         DISABLE  //是否使用外部上拉
...
#define TCFG_ADKEY_AD1      (0x3ffL * 200   / (200   + R_UP))     //20k
#define TCFG_ADKEY_AD2      (0x3ffL * 330  / (330   + R_UP))     //36k
...
#define TCFG_ADKEY_VOLTAGE2 ((TCFG_ADKEY_AD2 + TCFG_ADKEY_VDDIO) / 2)
...
#define TCFG_AUDIO_ADC_LINE_CHA				LADC_LINE1_MASK
...
#define TCFG_AD2DA_LOW_LATENCY_SAMPLE_RATE      (32000)         // 目前混叠仅支持固定 44100
...
#define ANCR_FB_MIC							A_MIC0                //ANC右通道FBMIC类型
...
#if (IIS_ROLE == ROLE_S && TCFG_APP_LINEIN_EN && TCFG_ADC_IIS_ENABLE)
...
//*********************************************************************************//
#if(TCFG_APP_LINEIN_EN && TCFG_ADC_IIS_ENABLE && IIS_ROLE == ROLE_S)
#define TCFG_LOWPOWER_POWER_SEL				PWR_LDO15	//PWR_DCDC15//PWR_LDO15     //电源模式设置，可选DCDC和LDO
#else
...
#if (TCFG_ADC_IIS_ENABLE && TCFG_APP_LINEIN_EN && IIS_ROLE == ROLE_S)
#define TCFG_SYS_LVD_EN						      0   //电量检测使能
#else
#define TCFG_SYS_LVD_EN						      1   //电量检测使能
#endif
#if (TCFG_ADC_IIS_ENABLE && TCFG_APP_LINEIN_EN && IIS_ROLE == ROLE_S)
#define TCFG_POWER_ON_NEED_KEY                               1   //iis从机是否使能按键开机
#define IIS_SLAVE_AWAKEN_PORT					  IO_PORTC_02	//iis从机唤醒的io口
#else
