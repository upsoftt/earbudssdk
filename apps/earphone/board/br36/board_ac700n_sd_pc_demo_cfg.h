#ifndef CONFIG_BOARD_AC700N_SD_PC_DEMO_CFG_H
#define CONFIG_BOARD_AC700N_SD_PC_DEMO_CFG_H

#include "board_ac700n_sd_pc_demo_global_build_cfg.h"
...
#define TCFG_FLASH_DEV_SPI_CS_PORT	    	IO_PORTC_06

//*********************************************************************************//
//                                  music模式 配置                                 //
//*********************************************************************************//
#if TCFG_SD0_ENABLE
#define TCFG_APP_MUSIC_EN			              ENABLE             //应用代码
...
#define TCFG_IOKEY_PREV_ONE_PORT			IO_PORTB_07
...
#else
#define TCFG_AUDIO_MIC_MODE					AUDIO_MIC_CAPLESS_MODE
#define TCFG_AUDIO_MIC1_MODE				AUDIO_MIC_CAPLESS_MODE
#endif/*TCFG_AUDIO_ANC_ENABLE*/
...
//                                  系统配置                                         //
//*********************************************************************************//
#define TCFG_AUTO_SHUT_DOWN_TIME		          0   //不支持自动关机
...
#define TCFG_DEC_LC3_ENABLE				    0
#define TCFG_ENC_LC3_ENABLE				    0
...
#define CONFIG_MUSIC_DEC_CLOCK			(96 * 1000000L)
#define CONFIG_MUSIC_IDLE_CLOCK		    (96 * 1000000L)
...
#endif //CONFIG_BOARD_AC700N_SD_PC_DEMO
#endif //CONFIG_BOARD_AC700N_SD_PC_DEMO_CFG_H
