#ifndef CONFIG_BOARD_AC7006N_HEARING_AID_CFG_H
#define CONFIG_BOARD_AC7006N_HEARING_AID_CFG_H

#include "board_ac700n_hearing_aid_global_build_cfg.h"

#ifdef CONFIG_BOARD_AC700N_HEARING_AID
...
/*是否开机进入独立辅听模式*/
#define TCFG_ENTER_HEARING_AID_MODE         ENABLE
/*听力验配功能*/
...
/*辅听VAD低功耗模式：仅独立辅听模式有效*/
#define TCFG_AUDIO_DHA_LOW_POWER_ENABLE		DISABLE
