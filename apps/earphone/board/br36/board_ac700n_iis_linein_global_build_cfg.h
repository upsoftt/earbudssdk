...
#ifndef CONFIG_BOARD_AC700N_IIS_LINEIN_POST_BUILD_CFG_H
#define CONFIG_BOARD_AC700N_IIS_LINEIN_POST_BUILD_CFG_H
...
//*********************************************************************************//
//是否开机进入LINEIN模式
#define TCFG_APP_LINEIN_EN             ENABLE
//LINEIN PCM数据是否走解码
#define TCFG_LINEIN_PCM_DECODER		   ENABLE
//是否使能 IIS 收发linein数据功能
#define TCFG_ADC_IIS_ENABLE            ENABLE
#define ROLE_M         1
#define ROLE_S         0
//选择作为iis主机还是从机
#define IIS_ROLE       ROLE_M
#define LINEIN_DET_PORT		IO_PORT_DM
#define LINEIN_DET_CH		AD_CH_DM
#if (TCFG_APP_LINEIN_EN && TCFG_ADC_IIS_ENABLE && IIS_ROLE == ROLE_S)
#define IIS_LINEIN_HW_SRC_EN 	ENABLE		//使能从机iis变采样
#undef TCFG_LINEIN_PCM_DECODER
#define TCFG_LINEIN_PCM_DECODER 		  DISABLE
#endif
...
#if (TCFG_APP_LINEIN_EN && TCFG_ADC_IIS_ENABLE && (IIS_ROLE == ROLE_S))
#define CONFIG_PLL_SOURCE_USING_LRC             1        			//PLL时钟源选择 1:LRC 2:OSC，从机默认省晶振
#else
#define CONFIG_PLL_SOURCE_USING_LRC             2        			//PLL时钟源选择 1:LRC 2:OSC
#endif
