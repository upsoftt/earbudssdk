...
STATUS_CONFIG status_config = {
    //灯状态设置
    .led = {
        .charge_start  = PWM_LED0_ON,       //0:橙灯1:白灯
        .charge_full   = PWM_LED_ALL_OFF,
        .power_on      = PWM_LED0_FLASH_THREE,
        .power_off     = PWM_LED0_FLASH_THREE,  //橙灯常亮
        .lowpower      = PWM_LED0_ONE_FLASH_5S,
        ...
        .tws_disconnect = PWM_LED0_LED1_FAST_FLASH,
    },
    //提示音设置
    .tone = {
...
#if TCFG_LP_TOUCH_KEY_ENABLE
#if !EARPHONE_POWERON_CTRL_EN    ///按键开机开关
