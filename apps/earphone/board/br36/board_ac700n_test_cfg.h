#ifndef CONFIG_BOARD_AC7006N_TEST_CFG_H
#define CONFIG_BOARD_AC7006N_TEST_CFG_H

#include "board_ac700n_test_global_build_cfg.h"
...
/*通话下行降噪使能*/
#define TCFG_ESCO_DL_NS_ENABLE				0//ENABLE_THIS_MOUDLE
