#ifndef CONFIG_BOARD_AC700N_AID_POST_BUILD_CFG_H
#define CONFIG_BOARD_AC700N_AID_POST_BUILD_CFG_H

/* 改文件只添加和isd_config.ini相关的配置，用以生成isd_config.ini */
/* 其他不相关的配置请勿添加在改文件 */

#ifdef CONFIG_BOARD_AC700N_HEARING_AID
/* Following acros Affect Periods Of Both Code Compiling And Post-build */
