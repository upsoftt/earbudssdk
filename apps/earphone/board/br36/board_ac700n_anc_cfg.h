#ifndef CONFIG_BOARD_AC700N_ANC_CFG_H
#define CONFIG_BOARD_AC700N_ANC_CFG_H

#include "board_ac700n_anc_global_build_cfg.h"

#ifdef CONFIG_BOARD_AC700N_ANC

#define CONFIG_SDFILE_ENABLE

#define DEVE_BOARD							0x01
#define I3_HYBIRD							0x02
#define I3_FF_DD							0x03
#define QCY_HYBIRD							0x04
#define HEAD_PHONE_FB						0x05
#define LIULV_FF							0x06
#define XRS_G69_FF							0x07
#define KNX_A1023_HYBIRD					0x08
#define YC_M6_HEAD_PHONE_FB					0x09
#define MT_HEAD_PHONE_FB					0x0a
#define LY905_HEAD_PHONE_FB					0x0b
#define TG931_HEAD_PHONE_FB					0x0c
#define DXC_M11_FF							0x0d
#define JX_FF							    0x0e
#define VJ088_HEAD_PHONE_FB				    0x0f
#define MESS_S11_FF     				    0x10
#define KNX_A896_HYBIRD					    0x11
#define VJ088_HEAD_PHONE_HYBIRD				0x12
#define KPH_HEAD_PHONE_FB			     	0x13
#define XLB_88_BD18       			     	0x14
#define LW_HEAD_PHONE_FB               		0x15
#define J33_B_FB         			     	0x16
#define A3_FF         			         	0x17
#define XLX_N08_HYBIRD         			    0x18
#define CLIENT_BOARD 					    DXC_M11_FF
...
#if CLIENT_BOARD ==  DEVE_BOARD || \
	CLIENT_BOARD == XRS_G69_FF  || \
	CLIENT_BOARD == LW_HEAD_PHONE_FB
...
//                                 iokey 配置                                      //
//*********************************************************************************//
#if CLIENT_BOARD == I3_FF_DD
#define TCFG_IOKEY_ENABLE					ENABLE_THIS_MOUDLE //是否使能IO按键
#define TCFG_IOKEY_POWER_CONNECT_WAY		ONE_PORT_TO_LOW    //按键一端接低电平一端接IO
#define TCFG_IOKEY_POWER_ONE_PORT			IO_PORTC_04        //IO按键端口

#elif CLIENT_BOARD == QCY_HYBIRD
#define TCFG_IOKEY_ENABLE					ENABLE_THIS_MOUDLE //是否使能IO按键
#define TCFG_IOKEY_POWER_CONNECT_WAY		ONE_PORT_TO_LOW    //按键一端接低电平一端接IO
#define TCFG_IOKEY_POWER_ONE_PORT			IO_PORTB_02        //IO按键端口

#elif CLIENT_BOARD == HEAD_PHONE_FB		 || \
	  CLIENT_BOARD == DEVE_BOARD   		 || \
	  CLIENT_BOARD == KNX_A1023_HYBIRD   || \
	  CLIENT_BOARD == XRS_G69_FF   		 || \
	  CLIENT_BOARD == XLX_N08_HYBIRD     || \
	  CLIENT_BOARD == KNX_A896_HYBIRD
#define TCFG_IOKEY_ENABLE					ENABLE_THIS_MOUDLE //是否使能IO按键
#define TCFG_IOKEY_POWER_CONNECT_WAY		ONE_PORT_TO_LOW    //按键一端接低电平一端接IO
#define TCFG_IOKEY_POWER_ONE_PORT			IO_PORTB_01        //IO按键端口

#elif CLIENT_BOARD == YC_M6_HEAD_PHONE_FB || \
	  CLIENT_BOARD == TG931_HEAD_PHONE_FB
//沄成 M6
//艾玛威
#define TCFG_IOKEY_ENABLE					ENABLE_THIS_MOUDLE //是否使能IO按键
#define TCFG_IOKEY_POWER_CONNECT_WAY		ONE_PORT_TO_LOW    //按键一端接低电平一端接IO
...
#define TCFG_IOKEY_PREV_ONE_PORT			IO_PORTB_09

#define TCFG_IOKEY_NEXT_CONNECT_WAY 		ONE_PORT_TO_LOW  //按键一端接低电平一端接IO
#define TCFG_IOKEY_NEXT_ONE_PORT			IO_PORTC_03

#define TCFG_IOKEY_ANC_CONNECT_WAY	    	ONE_PORT_TO_LOW    //按键一端接低电平一端接IO
#define TCFG_IOKEY_ANC_ONE_PORT			    IO_PORTC_04        //IO按键端口


#elif CLIENT_BOARD == A3_FF
#define TCFG_IOKEY_ENABLE					ENABLE_THIS_MOUDLE //是否使能IO按键
#define TCFG_IOKEY_POWER_CONNECT_WAY		ONE_PORT_TO_LOW    //按键一端接低电平一端接IO
#define TCFG_IOKEY_POWER_ONE_PORT			IO_PORTB_01        //IO按键端口

#define TCFG_IOKEY_PREV_CONNECT_WAY			ONE_PORT_TO_LOW  //按键一端接低电平一端接IO
#define TCFG_IOKEY_PREV_ONE_PORT			IO_PORTB_03

#define TCFG_IOKEY_NEXT_CONNECT_WAY 		ONE_PORT_TO_LOW  //按键一端接低电平一端接IO
#define TCFG_IOKEY_NEXT_ONE_PORT			IO_PORTC_04

#define TCFG_IOKEY_ANC_CONNECT_WAY	    	ONE_PORT_TO_LOW    //按键一端接低电平一端接IO
#define TCFG_IOKEY_ANC_ONE_PORT			    IO_PORTC_05       //IO按键端口


#elif CLIENT_BOARD == VJ088_HEAD_PHONE_FB
#define TCFG_IOKEY_ENABLE					ENABLE_THIS_MOUDLE //是否使能IO按键
#define TCFG_IOKEY_POWER_CONNECT_WAY		ONE_PORT_TO_LOW    //按键一端接低电平一端接IO
#define TCFG_IOKEY_POWER_ONE_PORT			IO_PORTB_01        //IO按键端口
...
#define TCFG_IOKEY_NEXT_CONNECT_WAY 		ONE_PORT_TO_LOW  //按键一端接低电平一端接IO
#define TCFG_IOKEY_NEXT_ONE_PORT			IO_PORTC_05

#elif CLIENT_BOARD == J33_B_FB
#define TCFG_IOKEY_ENABLE					ENABLE_THIS_MOUDLE //是否使能IO按键
#define TCFG_IOKEY_POWER_CONNECT_WAY		ONE_PORT_TO_LOW    //按键一端接低电平一端接IO
#define TCFG_IOKEY_POWER_ONE_PORT			IO_PORTC_04//IO按键端口

#define TCFG_IOKEY_PREV_CONNECT_WAY			ONE_PORT_TO_LOW  //按键一端接低电平一端接IO
#define TCFG_IOKEY_PREV_ONE_PORT			IO_PORTC_03

#define TCFG_IOKEY_NEXT_CONNECT_WAY 		ONE_PORT_TO_LOW  //按键一端接低电平一端接IO
#define TCFG_IOKEY_NEXT_ONE_PORT			IO_PORTC_05


#elif CLIENT_BOARD == MT_HEAD_PHONE_FB
//摩天
#define TCFG_IOKEY_ENABLE					ENABLE_THIS_MOUDLE //是否使能IO按键
#define TCFG_IOKEY_POWER_CONNECT_WAY		ONE_PORT_TO_LOW    //按键一端接低电平一端接IO
#define TCFG_IOKEY_POWER_ONE_PORT			IO_PORTB_01        //IO按键端口
...
#define TCFG_IOKEY_NEXT_CONNECT_WAY 		ONE_PORT_TO_LOW  //按键一端接低电平一端接IO
#define TCFG_IOKEY_NEXT_ONE_PORT			IO_PORTB_09

#elif CLIENT_BOARD == KPH_HEAD_PHONE_FB
#define TCFG_IOKEY_ENABLE					ENABLE_THIS_MOUDLE //是否使能IO按键
#define TCFG_IOKEY_POWER_CONNECT_WAY		ONE_PORT_TO_LOW    //按键一端接低电平一端接IO
#define TCFG_IOKEY_POWER_ONE_PORT			IO_PORTB_01        //IO按键端口
...
//                                 adkey 配置                                      //
//*********************************************************************************//
#if CLIENT_BOARD == LY905_HEAD_PHONE_FB
...
#define TCFG_ADKEY_AD1      (0x3ffL * 180   / (180   + R_UP))     //18k
#define TCFG_ADKEY_AD2      (0x3ffL * 360   / (360   + R_UP))     //36k
#define TCFG_ADKEY_AD3      (0x3ffL * 750   / (750   + R_UP))     //75k
...
//*********************************************************************************//
#if CLIENT_BOARD == I3_FF_DD      || \
	CLIENT_BOARD == QCY_HYBIRD 	  || \
	CLIENT_BOARD == HEAD_PHONE_FB || \
	CLIENT_BOARD == DEVE_BOARD	  || \
	CLIENT_BOARD == KNX_A1023_HYBIRD   	|| \
	CLIENT_BOARD == KNX_A896_HYBIRD   	|| \
	CLIENT_BOARD == YC_M6_HEAD_PHONE_FB || \
	CLIENT_BOARD == MT_HEAD_PHONE_FB    || \
	CLIENT_BOARD == LY905_HEAD_PHONE_FB || \
	CLIENT_BOARD == KPH_HEAD_PHONE_FB   || \
	CLIENT_BOARD == TG931_HEAD_PHONE_FB || \
	CLIENT_BOARD == VJ088_HEAD_PHONE_FB || \
	CLIENT_BOARD == LW_HEAD_PHONE_FB    || \
	CLIENT_BOARD == J33_B_FB 		    || \
	CLIENT_BOARD == XLX_N08_HYBIRD 	    || \
	CLIENT_BOARD == A3_FF
#define TCFG_LP_TOUCH_KEY_ENABLE 		0//	DISABLE_THIS_MOUDLE 		//是否使能触摸按键
#else
...
/*PDM数字MIC配置*/
#if CLIENT_BOARD == KNX_A896_HYBIRD     || \
	CLIENT_BOARD == XLX_N08_HYBIRD
...
#elif CLIENT_BOARD == VJ088_HEAD_PHONE_HYBIRD
#define TCFG_AUDIO_PLNK_SCLK_PIN			IO_PORTA_06
#define TCFG_AUDIO_PLNK_DAT0_PIN			IO_PORTC_03
#define TCFG_AUDIO_PLNK_DAT1_PIN			IO_PORTA_08
#else
#define TCFG_AUDIO_PLNK_SCLK_PIN			IO_PORTA_06
#define TCFG_AUDIO_PLNK_DAT0_PIN			IO_PORTA_08
#define TCFG_AUDIO_PLNK_DAT1_PIN			NO_CONFIG_PORT
...
#if CLIENT_BOARD == I3_HYBIRD	|| \
	CLIENT_BOARD == QCY_HYBIRD
#define ANC_TRAIN_MODE				ANC_HYBRID_EN
#define ANC_CH 						ANC_L_CH
#define ANCL_FF_MIC				    A_MIC0
#define ANCL_FB_MIC		            MIC_NULL
#define ANCR_FF_MIC		            A_MIC0
#define ANCR_FB_MIC		            A_MIC1

#elif CLIENT_BOARD == I3_FF_DD   || \
	  CLIENT_BOARD == XRS_G69_FF || \
	  CLIENT_BOARD == DXC_M11_FF || \
	  CLIENT_BOARD == JX_FF      || \
	  CLIENT_BOARD == MESS_S11_FF|| \
	  CLIENT_BOARD == XLB_88_BD18
#define ANC_TRAIN_MODE				ANC_FF_EN
#define ANC_CH 			 			ANC_L_CH
#define ANCL_FF_MIC		 		    A_MIC0
#define ANCL_FB_MIC		            MIC_NULL
#define ANCR_FF_MIC		            A_MIC0
#define ANCR_FB_MIC		            MIC_NULL

#elif CLIENT_BOARD == LIULV_FF
#define ANC_TRAIN_MODE				ANC_FF_EN
#define ANC_CH 						ANC_L_CH
#define ANCL_FF_MIC				    A_MIC0
#define ANCL_FB_MIC		            MIC_NULL
#define ANCR_FF_MIC		            MIC_NULL
#define ANCR_FB_MIC		            MIC_NULL

#elif CLIENT_BOARD == A3_FF
#define ANC_TRAIN_MODE				ANC_FF_EN
#define ANC_CH 						ANC_L_CH|ANC_R_CH
#define ANCL_FF_MIC				    A_MIC1
#define ANCL_FB_MIC		            MIC_NULL
#define ANCR_FF_MIC		            A_MIC0
#define ANCR_FB_MIC		            MIC_NULL
	  ...
	  CLIENT_BOARD == LW_HEAD_PHONE_FB    || \
	  CLIENT_BOARD == J33_B_FB
#define ANC_TRAIN_MODE				ANC_FB_EN
#define ANC_CH 						ANC_L_CH|ANC_R_CH
#define ANCL_FF_MIC				    MIC_NULL
#define ANCL_FB_MIC		            A_MIC1
#define ANCR_FF_MIC		            MIC_NULL
#define ANCR_FB_MIC		            A_MIC0

#elif CLIENT_BOARD == KNX_A1023_HYBIRD || \
	  CLIENT_BOARD == XLX_N08_HYBIRD   || \
	  CLIENT_BOARD == KNX_A896_HYBIRD
#define ANC_TRAIN_MODE				ANC_HYBRID_EN
#define ANC_CH 						ANC_R_CH
#define ANCL_FF_MIC				    MIC_NULL
#define ANCL_FB_MIC		            MIC_NULL
#define ANCR_FF_MIC		            A_MIC0
#define ANCR_FB_MIC		            D_MIC0

#elif CLIENT_BOARD == VJ088_HEAD_PHONE_HYBIRD
#define ANC_TRAIN_MODE				ANC_HYBRID_EN
#define ANC_CH 						ANC_L_CH|ANC_R_CH
#define ANCL_FF_MIC				    A_MIC1
#define ANCL_FB_MIC		            D_MIC1
#define ANCR_FF_MIC		            A_MIC0
#define ANCR_FB_MIC		            D_MIC3
...
#define TCFG_AD2DA_LOW_LATENCY_SAMPLE_RATE      (44100)         // 目前仅支持固定 44100
...
/*注意:ANC使能情况下使用软件数字音量*/
#if (TCFG_AUDIO_ANC_ENABLE || TCFG_AD2DA_LOW_LATENCY_ENABLE)
...
#else
#if CLIENT_BOARD == YC_M6_HEAD_PHONE_FB || \
	CLIENT_BOARD == MT_HEAD_PHONE_FB    || \
	CLIENT_BOARD == KPH_HEAD_PHONE_FB   || \
	CLIENT_BOARD == LY905_HEAD_PHONE_FB || \
	CLIENT_BOARD == TG931_HEAD_PHONE_FB || \
...
#elif CLIENT_BOARD == VJ088_HEAD_PHONE_HYBIRD || \
	  CLIENT_BOARD == LW_HEAD_PHONE_FB
#define TCFG_AUDIO_ADC_MIC_CHA				LADC_CH_PLNK
...
//配置MIC电源
#define TCFG_AUDIO_MIC_PWR_CTL				MIC_PWR_FROM_GPIO | MIC_PWR_FROM_MIC_LDO
...
//使用普通IO输出供电:不用的port配置成NO_CONFIG_PORT
    ...
    CLIENT_BOARD == MESS_S11_FF || \
    CLIENT_BOARD == DXC_M11_FF
#define TCFG_AUDIO_MIC_PWR_PORT				IO_PORTB_04
#define TCFG_AUDIO_MIC1_PWR_PORT			NO_CONFIG_PORT
#define TCFG_AUDIO_MIC2_PWR_PORT			NO_CONFIG_PORT

#elif CLIENT_BOARD == KNX_A1023_HYBIRD
#define TCFG_AUDIO_MIC_PWR_PORT				IO_PORTA_06
#define TCFG_AUDIO_MIC1_PWR_PORT			NO_CONFIG_PORT
#define TCFG_AUDIO_MIC2_PWR_PORT			IO_PORTB_04

#elif CLIENT_BOARD == XRS_G69_FF
#define TCFG_AUDIO_MIC_PWR_PORT				IO_PORT_DP
#define TCFG_AUDIO_MIC1_PWR_PORT			NO_CONFIG_PORT
#define TCFG_AUDIO_MIC2_PWR_PORT			NO_CONFIG_PORT

#elif CLIENT_BOARD == XLB_88_BD18
#define TCFG_AUDIO_MIC_PWR_PORT				IO_PORT_DM
#define TCFG_AUDIO_MIC1_PWR_PORT			NO_CONFIG_PORT
#define TCFG_AUDIO_MIC2_PWR_PORT			NO_CONFIG_PORT
#elif   CLIENT_BOARD == MT_HEAD_PHONE_FB 	|| \
        CLIENT_BOARD == KPH_HEAD_PHONE_FB 	|| \
        ...
        CLIENT_BOARD == J33_B_FB 			|| \
        CLIENT_BOARD == A3_FF
#define TCFG_AUDIO_MIC_PWR_PORT				IO_PORTA_05
#define TCFG_AUDIO_MIC1_PWR_PORT			NO_CONFIG_PORT
#define TCFG_AUDIO_MIC2_PWR_PORT			NO_CONFIG_PORT

#elif CLIENT_BOARD == JX_FF
#define TCFG_AUDIO_MIC_PWR_PORT				IO_PORTB_02
#define TCFG_AUDIO_MIC1_PWR_PORT			NO_CONFIG_PORT
#define TCFG_AUDIO_MIC2_PWR_PORT			NO_CONFIG_PORT

#elif CLIENT_BOARD == KNX_A896_HYBIRD    || \
	  CLIENT_BOARD == KNX_A896_HYBIRD
#define TCFG_AUDIO_MIC_PWR_PORT				IO_PORTA_06
#define TCFG_AUDIO_MIC1_PWR_PORT			NO_CONFIG_PORT
#define TCFG_AUDIO_MIC2_PWR_PORT			NO_CONFIG_PORT
...
#elif CLIENT_BOARD == VJ088_HEAD_PHONE_HYBIRD
#define TCFG_AUDIO_MIC_PWR_PORT				IO_PORTA_05	//anc dmic
#define TCFG_AUDIO_MIC1_PWR_PORT			IO_PORTC_04 //audio dmic
#define TCFG_AUDIO_MIC2_PWR_PORT			NO_CONFIG_PORT
#else
...
#if (TCFG_AUDIO_ANC_ENABLE && (CLIENT_BOARD == MT_HEAD_PHONE_FB))
#undef TCFG_ANC_BOX_ENABLE
#undef TCFG_CHARGESTORE_PORT
#define TCFG_ANC_BOX_ENABLE			        1                         //是否支持ANC测试盒
#define TCFG_CHARGESTORE_PORT				IO_PORT_DM                //耳机和充点仓通讯的IO口
#endif
...
#elif CLIENT_BOARD == LY905_HEAD_PHONE_FB
#define TCFG_PWMLED_PIN0					IO_PORTC_02					//LED0使用的IO口
#define TCFG_PWMLED_PIN1					IO_PORTB_09					//LED1使用的IO口
#elif CLIENT_BOARD == XLB_88_BD18
#define TCFG_PWMLED_PIN0					IO_PORT_DP					//LED0使用的IO口
#define TCFG_PWMLED_PIN1					IO_PORTB_02
#elif CLIENT_BOARD == VJ088_HEAD_PHONE_FB
#define TCFG_PWMLED_PIN0					IO_PORTC_04 					//LED0使用的IO口
#define TCFG_PWMLED_PIN1					IO_PORTC_03
#elif CLIENT_BOARD == XRS_G69_FF        || \
	  CLIENT_BOARD == XLX_N08_HYBIRD
#define TCFG_PWMLED_PIN						IO_PORTB_02					//LED使用的IO口
#elif CLIENT_BOARD == JX_FF
#define TCFG_PWMLED_PIN						IO_PORT_DM					//LED使用的IO口
#elif CLIENT_BOARD == MESS_S11_FF || \
	  CLIENT_BOARD == QCY_HYBIRD  || \
	  CLIENT_BOARD == LW_HEAD_PHONE_FB
...
//*********************************************************************************//
	  ...
	  CLIENT_BOARD == TG931_HEAD_PHONE_FB || \
	  CLIENT_BOARD == VJ088_HEAD_PHONE_FB || \
	  CLIENT_BOARD == VJ088_HEAD_PHONE_HYBIRD || \
	  CLIENT_BOARD == LW_HEAD_PHONE_FB    || \
	  CLIENT_BOARD == J33_B_FB 			  || \
	  CLIENT_BOARD == A3_FF
 ...
 *3、ANC工具蓝牙spp调试
 */
#if (TCFG_AEC_TOOL_ONLINE_ENABLE || TCFG_AUDIO_DMS_DUT_ENABLE || TCFG_ANC_TOOL_DEBUG_ONLINE || TCFG_LP_TOUCH_KEY_BT_TOOL_ENABLE)|| (TCFG_COMM_TYPE == TCFG_SPP_COMM)
#undef USER_SUPPORT_PROFILE_SPP
...
#endif //CONFIG_BOARD_AC700N_ANC
#endif //CONFIG_BOARD_AC700N_ANC_CFG_H
