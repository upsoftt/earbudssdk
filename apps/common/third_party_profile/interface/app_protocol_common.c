...
u8 app_protocol_speech_wait = 0; //等待提示音播完之后再开始语音识别
...
{
    app_protocol_speech_wait = 0; //提示音没播完前，APP停止了
...
u8 app_protocal_get_bat_by_type(u8 type)
{
    ...
    printf("===app_protocal_get_bat_by_type:%d--%d\n", type, value);
    return value;
}
...
static int app_protocol_bt_status_event_handler(struct bt_event *bt)
{
    ...
    case BT_STATUS_FIRST_CONNECTED:
        ...
        app_protocal_update_bt_state_to_lib(USER_NOTIFY_STATE_MOBILE_CONNECTED);
        break;
    ...
    case BT_STATUS_SECOND_DISCONNECT:
        ...
        app_protocal_update_bt_state_to_lib(USER_NOTIFY_STATE_MOBILE_DISCONNECTED);
        break;
