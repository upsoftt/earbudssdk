...
static const uint8_t dma_profile_data[] = {
    ...
    // 0x0007 VALUE 2a00 READ | DYNAMIC
    ...
    // 0x0009 VALUE 2a01 READ | DYNAMIC
    0x08, 0x00, 0x02, 0x01, 0x09, 0x00, 0x01, 0x2a,

    /* CHARACTERISTIC,  2aa6, READ | DYNAMIC, */
    // 0x000a CHARACTERISTIC 2aa6 READ | DYNAMIC
    0x0d, 0x00, 0x02, 0x00, 0x0a, 0x00, 0x03, 0x28, 0x02, 0x0b, 0x00, 0xa6, 0x2a,
    // 0x000b VALUE 2aa6 READ | DYNAMIC
    0x08, 0x00, 0x02, 0x01, 0x0b, 0x00, 0xa6, 0x2a,
    ...
    //////////////////////////////////////////////////////
    //
    // 0x001a PRIMARY_SERVICE  fdc2
    //
    //////////////////////////////////////////////////////
    0x0a, 0x00, 0x02, 0x00, 0x1a, 0x00, 0x00, 0x28, 0xc2, 0xfd,

    /* CHARACTERISTIC,  b84ac9c6-29c5-46d4-bba1-9d534784330f, NOTIFY , */
    // 0x001b CHARACTERISTIC b84ac9c6-29c5-46d4-bba1-9d534784330f NOTIFY
    ...
    // 0x001c VALUE b84ac9c6-29c5-46d4-bba1-9d534784330f NOTIFY
    0x16, 0x00, 0x10, 0x02, 0x1c, 0x00, 0x0f, 0x33, 0x84, 0x47, 0x53, 0x9d, 0xa1, 0xbb, 0xd4, 0x46, 0xc5, 0x29, 0xc6, 0xc9, 0x4a, 0xb8,
    // 0x001d CLIENT_CHARACTERISTIC_CONFIGURATION
    0x0a, 0x00, 0x0a, 0x01, 0x1d, 0x00, 0x02, 0x29, 0x00, 0x00,

    /* CHARACTERISTIC,  c2e758b9-0e78-41e0-b0cb-98a593193fc5, WRITE | WRITE_WITHOUT_RESPONSE | DYNAMIC, */
    // 0x001e CHARACTERISTIC c2e758b9-0e78-41e0-b0cb-98a593193fc5 WRITE | WRITE_WITHOUT_RESPONSE | DYNAMIC
    ...
    // 0x001f VALUE c2e758b9-0e78-41e0-b0cb-98a593193fc5 WRITE | WRITE_WITHOUT_RESPONSE | DYNAMIC
    0x16, 0x00, 0x0c, 0x03, 0x1f, 0x00, 0xc5, 0x3f, 0x19, 0x93, 0xa5, 0x98, 0xcb, 0xb0, 0xe0, 0x41, 0x78, 0x0e, 0xb9, 0x58, 0xe7, 0xc2,

    //////////////////////////////////////////////////////
    //
    // 0x0020 PRIMARY_SERVICE  fdc3
    //
    //////////////////////////////////////////////////////
    0x0a, 0x00, 0x02, 0x00, 0x20, 0x00, 0x00, 0x28, 0xc3, 0xfd,

    /* CHARACTERISTIC,  0000FF00-0000-1000-8000-00805F9B34FB, WRITE |NOTIFY | DYNAMIC, */
    // 0x0021 CHARACTERISTIC 0000FF00-0000-1000-8000-00805F9B34FB WRITE |NOTIFY | DYNAMIC
    0x1b, 0x00, 0x02, 0x00, 0x21, 0x00, 0x03, 0x28, 0x18, 0x22, 0x00, 0xfb, 0x34, 0x9b, 0x5f, 0x80, 0x00, 0x00, 0x80, 0x00, 0x10, 0x00, 0x00, 0x00, 0xff, 0x00, 0x00,
    // 0x0022 VALUE 0000FF00-0000-1000-8000-00805F9B34FB WRITE |NOTIFY | DYNAMIC
    0x16, 0x00, 0x18, 0x03, 0x22, 0x00, 0xfb, 0x34, 0x9b, 0x5f, 0x80, 0x00, 0x00, 0x80, 0x00, 0x10, 0x00, 0x00, 0x00, 0xff, 0x00, 0x00,
...
#define ATT_CHARACTERISTIC_0000FF00_0000_1000_8000_00805F9B34FB_01_VALUE_HANDLE 0x0022
#define ATT_CHARACTERISTIC_0000FF00_0000_1000_8000_00805F9B34FB_01_CLIENT_CONFIGURATION_HANDLE 0x0023
