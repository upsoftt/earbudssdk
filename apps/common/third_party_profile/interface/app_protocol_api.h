...
#define APP_PROTOCOL_REALME_CODE    0
#define APP_PROTOCOL_GFPS_CODE      0
#define APP_PROTOCOL_NECM_CODE      0
#define APP_PROTOCOL_WSP_CODE       0
...
#define NECM_HANDLER_ID   0xB00     /*网易云音乐协议接口ID*/
#define WSP_HANDLER_ID    0xC00     /*Windows迅速配对ID*/
