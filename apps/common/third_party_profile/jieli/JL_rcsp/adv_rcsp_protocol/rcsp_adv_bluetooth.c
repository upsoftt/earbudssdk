...
#else
    .key_setting = {
        RCSP_EAR_CHANNEL_LEFT, RCSP_KEY_ACTION_CLICK, ADV_KEY_TYPE_NULL, \
        RCSP_EAR_CHANNEL_RIGHT, RCSP_KEY_ACTION_CLICK, ADV_KEY_TYPE_NULL, \
        RCSP_EAR_CHANNEL_LEFT, RCSP_KEY_ACTION_DOUBLE_CLICK, ADV_KEY_TYPE_PP, \ 
        RCSP_EAR_CHANNEL_RIGHT, RCSP_KEY_ACTION_DOUBLE_CLICK, ADV_KEY_TYPE_PP, \ 
        RCSP_EAR_CHANNEL_LEFT, RCSP_KEY_ACTION_TRIPLE_CLICK, ADV_KEY_TYPE_PREV, \ 
        RCSP_EAR_CHANNEL_RIGHT, RCSP_KEY_ACTION_TRIPLE_CLICK, ADV_KEY_TYPE_NEXT, \ 
        RCSP_EAR_CHANNEL_LEFT, RCSP_KEY_ACTION_LONG_CLICK,  ADV_KEY_TYPE_OPEN_SIRI, \ 
        RCSP_EAR_CHANNEL_RIGHT, RCSP_KEY_ACTION_LONG_CLICK, ADV_KEY_TYPE_OPEN_SIRI, \ 
    },
    // .key_setting = {
    //     RCSP_EAR_CHANNEL_LEFT, RCSP_KEY_ACTION_CLICK, ADV_KEY_TYPE_DESC_VOICE, \
    //     RCSP_EAR_CHANNEL_RIGHT, RCSP_KEY_ACTION_CLICK, ADV_KEY_TYPE_INC_VOICE, \ 
    //     RCSP_EAR_CHANNEL_LEFT, RCSP_KEY_ACTION_DOUBLE_CLICK, ADV_KEY_TYPE_PP, \ 
    //     RCSP_EAR_CHANNEL_RIGHT, RCSP_KEY_ACTION_DOUBLE_CLICK, ADV_KEY_TYPE_PP, \ 
    //     RCSP_EAR_CHANNEL_LEFT, RCSP_KEY_ACTION_TRIPLE_CLICK, ADV_KEY_SIRI, \ 
    //     RCSP_EAR_CHANNEL_RIGHT, RCSP_KEY_ACTION_TRIPLE_CLICK, ADV_KEY_SIRI, \ 
    //     RCSP_EAR_CHANNEL_LEFT, RCSP_KEY_ACTION_LONG_CLICK,  ADV_KEY_TYPE_PREV, \ 
    //     RCSP_EAR_CHANNEL_RIGHT, RCSP_KEY_ACTION_LONG_CLICK, ADV_KEY_TYPE_NEXT, \ 
    // },
#endif
    .key_extra_setting = {
        0
        ...
        while (dlen >= 3) {
            if (pbuf[0] == 0x01) {
                if (pbuf[1] == 0x01) {
                    ...
                    _s_info.key_setting[14] = pbuf[2];
                }
				else if (pbuf[1] == 0x04) {
                    _s_info.key_setting[20] = pbuf[2];
                }
            } else if (pbuf[0] == 0x02) {
                if (pbuf[1] == 0x01) {
                    ...
                    _s_info.key_setting[17] = pbuf[2];
                }
			   else if (pbuf[1] == 0x04) {
                    _s_info.key_setting[23] = pbuf[2];
                }
            }
            dlen -= 3;
            pbuf += 3;
