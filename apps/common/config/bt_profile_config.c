...
const u8 sdp_avctp_ta_service_data_v10[67] = {
0x36, 0x00, 0x3E, 0x09, 0x00, 0x00, 0x0A, 0x00, 0x01, 0x00, 0x05, 0x09, 0x00, 0x01, 0x36, 0x00,
0x03, 0x19, 0x11, 0x0C, 0x09, 0x00, 0x04, 0x36, 0x00, 0x12, 0x36, 0x00, 0x06, 0x19, 0x01, 0x00,
0x09, 0x00, 0x17, 0x36, 0x00, 0x06, 0x19, 0x00, 0x17, 0x09, 0x01, 0x04/*AVCTP VERSION*/, 0x09, 0x00, 0x09, 0x36,0x00, 0x09, 0x36, 0x00, 0x06, 0x19, 0x11, 0x0E, 0x09, 0x01, 0x06/*AVRCP VERSION*/, 0x09, 0x03, 0x11, 0x09, 0x00, 0x02, 0x00, 0x00,
};

const u8 sdp_avctp_ct_service_data_v10[70] = {
0x36, 0x00, 0x41, 0x09, 0x00, 0x00, 0x0A, 0x00, 0x01, 0x00, 0x02, 0x09, 0x00, 0x01, 0x36, 0x00,
0x06, 0x19, 0x11, 0x0E, 0x19, 0x11, 0x0F, 0x09, 0x00, 0x04, 0x36, 0x00, 0x12, 0x36, 0x00, 0x06,
0x19, 0x01, 0x00, 0x09, 0x00, 0x17, 0x36, 0x00, 0x06, 0x19, 0x00, 0x17, 0x09, 0x01, 0x04/*AVCTP VERSION*/, 0x09,0x00, 0x09, 0x36, 0x00, 0x09, 0x36, 0x00, 0x06, 0x19, 0x11, 0x0E, 0x09, 0x01, 0x06/*AVRCP VERSION*/, 0x09, 0x03,0x11, 0x09, 0x00, 0x01, 0x00, 0x00,
};
...
SDP_RECORD_HANDLER_REGISTER(arp_ct_sdp_record_item) = {
    ...
    .service_record = (u8 *)sdp_avctp_ct_service_data_v10,
    .service_record_handle = 0x00010002,
};
#if BT_SUPPORT_MUSIC_VOL_SYNC
SDP_RECORD_HANDLER_REGISTER(arp_ta_sdp_record_item) = {
    //.service_record = (u8 *)sdp_avctp_ta_service_data,
    .service_record = (u8 *)sdp_avctp_ta_service_data_v10,
    .service_record_handle = 0x00010005,
};
#endif
#endif

const u8 sdp_hfp_service_data_v10[77] = { 
0x36, 0x00, 0x48, 0x09, 0x00, 0x00, 0x0A, 0x00, 0x01, 0x00, 0x03, 0x09, 0x00, 0x01, 0x36, 0x00,
0x06, 0x19, 0x11, 0x1E, 0x19, 0x12, 0x03, 0x09, 0x00, 0x04, 0x36, 0x00, 0x0E, 0x36, 0x00, 0x03,
0x19, 0x01, 0x00, 0x36, 0x00, 0x05, 0x19, 0x00, 0x03, 0x08, 0x04, 0x09, 0x00, 0x09, 0x36, 0x00,
0x09, 0x36, 0x00, 0x06, 0x19, 0x11, 0x1E, 0x09, 0x01, 0x09/*hfp version*/, 0x09, 0x03, 0x11, 0x09, 0x00, 0x3F,
0x09, 0x01, 0x00, 0x25, 0x06, 0x4A, 0x4C, 0x5F, 0x48, 0x46, 0x50, 0x00, 0x00, 
};
...
SDP_RECORD_HANDLER_REGISTER(hfp_sdp_record_item) = {
    ...
    .service_record = (u8 *)sdp_hfp_service_data_v10,
...
const u8 sdp_user_spp_service_data[96] = {
    ...
    0x11, 0x1C, 
    0x00, 0x00, 0x11, 0x01, 0x00, 0x00, 0x10, 0x00, 0x80, 0x00, 0x00, 0x80, 0x5F, 0x9b,0x34, 0xfb,/*spp uuid */
...
//******a2dp delay report note*******///
u8 a2dp_support_delay_report = 0;
//1、把上方的变量置1开启功能
//2、在bt_function_select_init()会配置一个初始值
//3、按键切换低延时模式的时候更新初始值
//在按键切换的时候要判断是低延时模式，重新配置连接初始值
//set_default_delay_report_time(SBC_DELAY_TIME,AAC_DELAY_TIME);
//在按键切换到普通模式，重新配置连接初始值
//set_default_delay_report_time(CONFIG_A2DP_DELAY_TIME,CONFIG_A2DP_DELAY_TIME);
//4、调用 void update_a2dp_delay_report_time(u16 time) 函数动态更新延时值
//******a2dp delay report note end*******///
